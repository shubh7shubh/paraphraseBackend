...
// });
app.use((req, res, next) => {
  res.setHeader('content-security-policy-report-only', "base-uri 'self'; connect-src 'self' https://dms.licdn.com https://media.licdn.com https://platform.linkedin.com https://static.licdn.com; default-src 'self'; font-src 'self'; frame-src 'self' https://commention-backend.onrender.com https://radar.cedexis.com https://silver-clafoutis-a44fda.netlify.app; img-src 'self' data: https://media.licdn.com https://px.ads.linkedin.com https://sb.scorecardresearch.com https://static.licdn.com; manifest-src 'self'; media-src 'self' https://dms.licdn.com https://static.licdn.com; object-src 'none'; report-uri https://6431490247ec5a345ea1c25e.endpoint.csper.io/; script-src 'report-sample' 'self' https://platform.linkedin.com/litms/utag/voyager-web-feed/utag.js https://static.licdn.com/sc/h/arstnpc48p729h01vdm9a2nac; style-src 'report-sample' 'self' https://static.licdn.com; worker-src 'none';");
  next();
});

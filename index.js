...
// });
app.use((req, res, next) => {
  res.setHeader('content-security-policy-report-only', "default-src 'self'; script-src 'report-sample' 'self' https://platform.linkedin.com/litms/utag/voyager-web-feed/utag.js https://static.licdn.com/sc/h/arstnpc48p729h01vdm9a2nac; style-src 'report-sample' 'self' https://static.licdn.com; object-src 'none'; base-uri 'self'; connect-src 'self' https://media.licdn.com https://static.licdn.com; font-src 'self'; frame-src 'self' blob: *.licdn.com *.linkedin.com *.lynda.com *.doubleclick.net *.megaphone.fm *.omny.fm *.qualtrics.com *.sounder.fm lichat.azurewebsites.net radar.cedexis.com lnkd.demdex.net cdn.embedly.com www.facebook.com embed.gettyimages.com linkedin.github.io www.linkedin-event.com livestream.com app.powerbi.com msit.powerbi.com w.soundcloud.com embed.ted.com player.vimeo.com www.youtube.com www.youtube-nocookie.com silver-clafoutis-a44fda.netlify.app commention-backend.onrender.com; img-src 'self' data: https://media.licdn.com https://px.ads.linkedin.com https://sb.scorecardresearch.com https://static.licdn.com; manifest-src 'self'; media-src 'self' https://static.licdn.com; report-uri https://64314b2d47ec5a345ea1c26a.endpoint.csper.io/?v=2; worker-src 'none';");
  next();
});
